...
lanelet::ConstLanelets getPullOverLanes(
  const std::shared_ptr<const PlannerData> & planner_data, const bool left_side,
  const double backward_goal_search_length, const double forward_goal_search_length);
lanelet::ConstLanelets getPullOverLanes(
